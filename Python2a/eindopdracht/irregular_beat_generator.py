...
########## section for all the functions i use in my program ###########  
...
while run_the_program:
    ...
    while retrieve_bars:
        try:
            bars_amount = int(input("\nHow many bars do you want to be generated? Please give a number between 1 and 8\n"))
        except:
            print("\nSorry, can u please give a number between 1 and 8")
        else:
            if bars_amount in range(1,9):
                retrieve_bars = False
            else:
                print("\nSorry, can u please give a number between 1 and 8")
    ...
    #duplicated and/or variate the generated pattern according to amount of bars
    ...
    #convert the ts of the events to durations in milliseconds and add them together afterwards
    ...
    #convert timestamps in eigtht notes to ts in actual time
    ...
    while retrieve_gen_rhythm:
        matches = ['yes', 'Yes', 'y', 'Y', 'YES', 'no', 'No', 'n', 'N', 'NO']
        try:
            gen_rhythm = str(input("\nDo you want to generate a new rhythm? Type yes or no.\n"))
        except:
            print("\nSorry, can u please type yes or no")
        else: 
            if gen_rhythm in matches:
                retrieve_gen_rhythm = False
            else: 
                 print("\nSorry, can u please type yes or no")

    if gen_rhythm not in matches_true:
        print("\n Okay, thanks for using the program. Quiting...")
        run_the_program = False
    else: 
        print("\n\n Okay, lets generate a new rhythm")
